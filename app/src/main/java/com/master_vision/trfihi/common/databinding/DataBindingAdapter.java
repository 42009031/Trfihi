...
public class DataBindingAdapter {
    ...
    public static void setTypeFace(View view, String font_name) {
        ...
        if (TextUtils.isEmpty(font_name)) {
            ...
            else if (font_name.equals(Helper.EN))
                textView.setTypeface(TypeFaceProvider.getEnTypeface());
            else if (font_name.equals("bold"))
                textView.setTypeface(TypeFaceProvider.getEnTypeface(), Typeface.BOLD);
        }
    }
    ...
    @BindingAdapter("bind:spinner_adapter")
    public static void setSpinnerAdapter(Spinner view, BaseAdapter adapter) {
        view.setAdapter(adapter);
    }
